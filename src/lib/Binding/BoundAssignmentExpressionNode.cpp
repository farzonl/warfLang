...
BoundExpressionNode *BoundAssignmentExpressionNode::BoundExpression() { return mBoundExpression.get(); }
...
BoundAssignmentExpressionNode::BoundAssignmentExpressionNode(
    ...
    : BoundExpressionNode(), mIdentifer(identifer), mBoundExpression(std::move(boundExpression)) {}